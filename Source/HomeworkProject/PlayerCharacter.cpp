...
void APlayerCharacter::Client_MoveDownMesh_Implementation(float HalfHeightAdjust)
{
	/*const APlayerCharacter* DefaultCharacter = GetClass()->GetDefaultObject<APlayerCharacter>();
	GetMesh()->SetRelativeLocation(DefaultCharacter->GetMesh()->GetRelativeLocation());*/
	OnEndSlide(HalfHeightAdjust);
}


void APlayerCharacter::Client_MoveUpMesh_Implementation(float HalfHeightAdjust)
{
	OnStartSlide(HalfHeightAdjust);
	/*FVector& MeshRelativeLocation = GetMesh()->GetRelativeLocation_DirectMutable();
	MeshRelativeLocation.Z = GetMesh()->GetRelativeLocation().Z + HalfHeight;*/
}
