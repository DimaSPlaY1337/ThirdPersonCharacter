...
class APawn;
UCLASS()
class HOMEWORKPROJECT_API APlatformTrigger : public AActor
{
	GENERATED_BODY()
...
public:
	...
	//OutLifetimeProps - св-ва которые должны быть отреплецированы
	//метод без которого нельзя реплецировать св-ва
...
private:
	...
	//передаётся старое значение св-ва
	UFUNCTION()
